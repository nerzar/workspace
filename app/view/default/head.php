...
<head>
    ...
    <META NAME="AUTHOR" CONTENT="iglazunoff">
    ...
    <meta property="og:title" content="Истринский завод металлоконструкций" />
    ...
    <title> <?php echo $services->route->printTitle(); ?> | Истринский завод металлоконструкций</title>

    <link rel="icon" type="image/ico" href="/dist/i/favicon.ico" />
