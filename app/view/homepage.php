...
<header class="header_home">
    ...
    <a href="javascript: off()" data-rf_from="tech_task" data-wow-duration=".5s" class="button wow animate__fadeInDown"
        data-rf_from="tech_task_form">
    ...
    <div class="swiper header_slider__content">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="/dist/i/clients/<?php echo $i ?>.gif" width="auto" width="auto"
                    alt="Клиенты Истринского завода металлоконструкций">
            </div>
            <?php
            }
            ?>
...
<section class="our_works">
    ...
    <div class="our_works-works">
        <div class="our_works-row">
            ...
            ?>
            <div class="our_works-item wow animate__bounceInUp" data-wow-offset="-10"
                data-wow-duration="<?php echo $j ?>s"
                style="background-image: url(/dist/i/ourworks/<?php echo $i ?>.jpg)"></div>
            <?php
                $j = $j + 0.5;
                ($j > 1.5) ? $j = 0.5 : $j;
            }
...
<section class="sert">
    ...
    <img class="wow animate__backInRight" data-wow-offset="-10" data-wow-duration="1s" src="/dist/i/homepage/sert-2.jpg"
        width="998px" height="1428px" alt="Сертификат Истринского ЗМК о включении в реестр проверенных организаций.">
</section>
...
<section class="today">
    ...
    <div class="today__cards">
        ...
        <div class="today__cards_item wow animate__backInRight" id="bg-2" data-wow-offset="-10"
        ...
        <div class="today__cards_item wow animate__backInRight" id="bg-3" data-wow-offset="-10"
        ...
        <div class="today__cards_item wow animate__backInRight" id="bg-4" data-wow-offset="-10"
    ...
    <h4 class="wow animate__backInUp" data-wow-offset="-10" data-wow-duration=".8s">Больше информации о нас и
        ...
        <a href="javascript: off();" data-rf_from="reference_list" class="button medium wow animate__backInUp"
            data-wow-offset="-10" data-wow-duration="1s">Получить референс-лист </a>
</section>
...
<section class="advantages">
    ...
    <div class="advantages__nav">
        <a href="javascript: off();" class="open" data-rf_adv-h="15 лет на рынке металлоконструкций"
            data-rf_adv-p="Наша компания представлена на рынке услуг с 2006 года" data-rf_adv-a=""><span></span> Опыт
            15 лет</a>
        <a href="javascript: off();" data-rf_adv-h="Здание под ключ"
            data-rf_adv-p="Развитая сеть партнеров-строителей в 16 субъектах РФ" data-rf_adv-a="Партнерам"
            data-rf_adv-al="/partners"><span></span> Здание под ключ</a>
        <a href="javascript: off();" data-rf_adv-h="Авторский надзор"
            data-rf_adv-p="Наш инженер приедет и проведет проверку металлоконструкций через год после поставки"
            data-rf_adv-a=""><span></span> Авторский надзор</a>
        <a href="javascript: off();" data-rf_adv-h="Гарантия ФЗ №384"
            data-rf_adv-p="Гарантия на все металлоконструкции по ФЗ №384" data-rf_adv-a=""><span></span> Гарантия ФЗ
            №384</a>
    </div>
</section>
